...
const AccountTypeSelection = () => {
  ...
  return (
    <div 
      className="relative flex flex-col py-30 items-center justify-center min-h-screen overflow-hidden" 
      style={{
    ...
    >
      ...
      <div className="max-w-4xl w-full text-center px-4 sm:px-6 relative z-20">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2">Choose Your Account Type</h1>
        <p className="text-lg sm:text-xl text-white mb-6 sm:mb-8">Select How You Want To Use Our Platform</p>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 md:gap-8 mb-8 w-full">
          ...
          >
            <div className="flex flex-col items-center justify-center py-4">
              ...
              <h3 className="md:text-lg  font-medium text-white">Personal Account</h3>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col items-center justify-center py-4">
              ...
              <h3 className="text-lg sm:text-xl font-medium text-white">Business Account</h3>
            </div>
          </div>
        </div>
          </div>
